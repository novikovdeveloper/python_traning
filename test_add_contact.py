...
def test_add_contact(app):
    ...
    app.create_contact(ContactModel(firstname="Alex", middlename="Middle", lastname="Bolduin", nickname="vasua228", title="no title", company="roga i kopita", address=
...
def test_add_contact_empty(app):
    app.login(username="admin", password="secret")
    app.create_contact(ContactModel(firstname="", middlename="", lastname="", nickname="", title="", company="", address=
